...
-}
module Data.Automaton.MSF.Trans.Maybe (
  module Data.Automaton.MSF.Trans.Maybe,
...
import Data.Automaton.MSF (MSF, arrM, constM, hoistS, liftS)
...
catchMaybe ::
  ...
  MSF m a b ->
  MSF m a b
catchMaybe msf1 msf2 = safely $ try (maybeToExceptS msf1) >> safe msf2
...
embed_ msf as = reactimateMaybe $ listToMaybeS as >>> liftS msf
